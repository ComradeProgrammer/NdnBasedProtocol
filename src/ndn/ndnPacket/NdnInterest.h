...
class NdnInterest: public NdnPacket{
     ...
     * @return pair<bool,uint8_t>, 1st value marks whether this packet contains hopLimit. 2nd is the value of hopLimit. if 1st value is set as true, 2nd value should be ignored
     * */
    ...
    */
    void setHopLimit(bool omitted, uint8_t value){hoplimitOmitted=omitted;hopLimit=value;}
