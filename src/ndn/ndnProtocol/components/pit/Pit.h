...
class Pit{
    ...
    virtual ~Pit()=default;
     /**
     * @brief get the entry for the given name; a new item will be created if no item for the given name is found
    ...
    */
     ...
     * @return shared_ptr of corresponding entry. return nullptr if no item is found
    */
