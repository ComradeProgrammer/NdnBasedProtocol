...
class TlvObjectList {
   public:
    // @brief create a list object containing an empty buffer in pre-assigned
    // size
    TlvObjectList(int _bufferSize = MTU);
   ...
   private:
    ...
    // write data in to buffer and increase the currentPos. data will be copied
    // but not modified or shallow saved
