...
class Transmitter{
    ...
    /**
     * @brief listen for the packet and call onReceiveEthernetPacket once a new packet is received. This funtion can block the current thread.
     */
    ...
    protected:
    /**
     * @brief find the registered protocol by protocol ID and notify the protocol by calling its onReceiveEthernetPacket() method. This function is THREAD SAFE, i.e.， this funtion will try to gain the lock. This function will be called by listen method.
     * 
