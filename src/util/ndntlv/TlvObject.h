...
class TlvObject {
   public:
     ...
     * @param _type type Number of tlv object, usually declared in util/declaration.h
     * @param length length of binary data
     * @param _buffer buffer containing data. This buffer will not be modified,saved or deleted. Instead, the constructor will alloc a new memory persist a copy of this data.
    */
    ...
    */
     ...
     * @param rawData buffer containing data. This buffer will not be modified,saved or deleted. Instead, the constructor will alloc a new memory persist a copy of this data.
    */
    ...
    //return the length of tlv object, NOT THE LENGTH OF BINARY DATA, but the 'L' in "TLV"
