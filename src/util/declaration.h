...
#define NDNADDR_HELLOINTERVAL 2
#define NDNADDR_ROUTERDEADINTERVAL 20

#define NDNADDR_WAITINTERVAL 8
#define NDNADDR_ADDRREQINTERVAL 1
#define NDNADDR_ADDRREVOKEINTERVAL 10
