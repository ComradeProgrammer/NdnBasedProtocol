...
class NdnRoutingNeighborStateExchange: public NdnRoutingNeighborState{
    public:
    NdnRoutingNeighborStateExchange(NdnRoutingNeighbor* _neighbor,NdnRoutingInterface* _interface,std::shared_ptr<Logger> _logger = nullptr): NdnRoutingNeighborState(_neighbor,_interface,_logger) {
