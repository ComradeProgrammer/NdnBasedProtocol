...
class NdnRoutingNeighborStateDown : public NdnRoutingNeighborState {
   public:
    NdnRoutingNeighborStateDown(NdnRoutingNeighbor* _neighbor,NdnRoutingInterface* _interface,std::shared_ptr<Logger> _logger = nullptr): NdnRoutingNeighborState(_neighbor,_interface,_logger) {
