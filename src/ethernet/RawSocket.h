...
class RawSocket {
   public:
    ...
    /**
     * @brief wait until the raw socket receive a packet of the specified protocol. This function will jam the current thread until a packet is received.
    ...
    * @warning this funtion will require the lock of this object and release it when returned.
